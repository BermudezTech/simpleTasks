...
<body style="background-image: url(educacion2.jpg); background-size: cover;">
	...
	<div class="logincontainer">
		<form action="#" id="formulario">
			...
			<div class="recordar" style="display: flex; justify-content: center; align-items: center;"><div class="chk"><input type="checkbox" name="recordar" id="recordar" style="width: auto;"></div><div class="lbl"><label for="recordar" style="font-weight: normal;">Guardar sesión en el navegador</label></div></div>
