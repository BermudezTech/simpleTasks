...
<div class="header">
	...
	<div class="left" style="display: flex;justify-content: center;align-items: center;"><img src="unnamed.png" width="40px" height="40px" style="margin-right: 20px;"><a href="inicio.php">Inicio</a></div>
	<div class="right">
		<p><?php echo $usuarioinfo['nombre']; ?></p>
		<div class="separador"><p>|</p></div>
		<div id="boton_desplegable" onclick="show_menu()"><p id="flecha">🔻</p></div>
		<div id="boton_desplegable1" onclick="hide_menu()"><p id="flecha">🔺</p></div>
